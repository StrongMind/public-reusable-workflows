...
class DashboardComponent(pulumi.ComponentResource):
    ...
    def setup_dashboard(self, project_stack, **kwargs):
      ...
      widgets.append(self.ecs_cluster.name.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/ECS", "CPUUtilization", "ClusterName", self.ecs_cluster.name.apply(lambda cluster_name: cluster_name), "ServiceName", self.web_container.fargate_service.name.apply(lambda service_name: service_name)]
              ],
              "period": 300,
              "stat": "Average",
              "region": "us-west-2",
      ...
      if self.autoscale:
          widgets.append(self.ecs_cluster.name.apply(lambda name: {
              ...
              "properties": {
                  "metrics": [
                      ["AWS/ApplicationAutoScaling", "NumberOfTasks", "ClusterName", self.ecs_cluster.name.apply(lambda cluster_name: cluster_name), "ServiceName", self.web_container.fargate_service.name.apply(lambda service_name: service_name), {"stat": "SampleCount"}]
                  ],
                  "period": 300,
                  "view": "timeSeries",
                  "stacked": False,
      ...
      widgets.append(self.ecs_cluster.name.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/ECS", "MemoryUtilization", "ClusterName", self.ecs_cluster.name.apply(lambda cluster_name: cluster_name), "ServiceName", self.web_container.fargate_service.name.apply(lambda service_name: service_name)]
              ],
              "period": 300,
              "stat": "Average",
              "region": "us-west-2",
      ...
      widgets.append(self.load_balancer_arn_name.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/ApplicationELB", "HealthyHostCount", "LoadBalancer", self.load_balancer_arn_name.apply(lambda load_balancer_arn_name: load_balancer_arn_name), "TargetGroup", self.target_group_arn.apply(lambda target_group_arn: target_group_arn)]
              ],
              "period": 300,
              "stat": "Minimum",
              "region": "us-west-2",
      ...
      widgets.append( self.load_balancer_arn_name.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/ApplicationELB", "RequestCount", "LoadBalancer", self.load_balancer_arn_name.apply(lambda load_balancer_arn_name: load_balancer_arn_name), {"stat": "Sum"}]
              ],
              "period": 300,
              "stat": "Sum",
              "region": "us-west-2",
      ...
      widgets.append( self.load_balancer_arn_name.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/ApplicationELB", "TargetResponseTime", "LoadBalancer", self.load_balancer_arn_name.apply(lambda load_balancer_arn_name: load_balancer_arn_name), {"stat": "Average"}]
              ],
              "period": 300,
              "stat": "Average",
              "region": "us-west-2",
      ...
      widgets.append(self.load_balancer_arn_name.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/ApplicationELB", "HTTPCode_Target_5XX_Count", "LoadBalancer", self.load_balancer_arn_name.apply(lambda load_balancer_arn_name: load_balancer_arn_name), {"stat": "Sum"}]
              ],
              "period": 300,
              "stat": "Sum",
              "region": "us-west-2",
      ...
      widgets.append(self.load_balancer_arn_name.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/ApplicationELB", "HTTPCode_Target_4XX_Count", "LoadBalancer", self.load_balancer_arn_name.apply(lambda load_balancer_arn_name: load_balancer_arn_name), {"stat": "Sum"}]
              ],
              "period": 300,
              "stat": "Sum",
              "region": "us-west-2",
      ...
      widgets.append(self.rds_serverless_cluster_instance.identifier.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/RDS", "CPUUtilization", "DBInstanceIdentifier", self.rds_serverless_cluster_instance.identifier.apply(lambda identifier: identifier)]
              ],
              "period": 300,
              "stat": "Average",
              "region": "us-west-2",
      ...
      widgets.append(self.rds_serverless_cluster_instance.identifier.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/RDS", "DatabaseConnections", "DBInstanceIdentifier", self.rds_serverless_cluster_instance.identifier.apply(lambda identifier: identifier)]
              ],
              "period": 300,
              "stat": "Average",
              "region": "us-west-2",
      ...
      widgets.append(self.rds_serverless_cluster_instance.identifier.apply(lambda name: {
          ...
          "properties": {
              "metrics": [
                  ["AWS/RDS", "ACUUtilization", "DBInstanceIdentifier", self.rds_serverless_cluster_instance.identifier.apply(lambda identifier: identifier)]
              ],
              "period": 300,
              "stat": "Average",
              "region": "us-west-2",
